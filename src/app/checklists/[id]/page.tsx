  ...
  return [
    {
      ...
      items: [
        ...
        { question: "Check Breakers & Power Cable",                 response: p("YES") },
        { question: "Check Radiator",                               response: p("YES") },
        { question: "Is the Solenoid Connected & Operational?",     response: p("YES") },
        { question: "Battery charger operational",                  response: p("YES") },
        { question: "Check Oil Sensor Protection",                  response: p("YES") },
        { question: "Radiator Horse free from cracks, no leaks",    response: p("YES") },
        { question: "Is The Machine burning Oil",                   response: p("NO")  },
      ],
    },
    {
      label: "DC System",
